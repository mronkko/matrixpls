...
#' 
#' @description
#' Plot method for objects of class \code{"matrixpls"}. This function plots either
...
#' 
#' @details
#' \code{plot.matrixpls} is just a wraper of \code{\link{innerplot}} 
...
#' @note Function \code{plot.matrixpls} is based on the function
...
#' \code{\link{matrixpls}}
#' @method plot matrixpls
#' @S3method plot matrixpls
#' @examples
#' 
#'  \dontrun{
